 ...
 * @author ANNELAURE
 */
public class RechercherPatientDMMedTech extends javax.swing.JFrame {
    private Personnel utilisateur;

    /**
     * Creates new form RechercherPatientDMMedTech
     */
    public RechercherPatientDMMedTech(Personnel utilisateur) {
        initComponents();
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (i<utilisateur.getListePatient().size()){
            AfficherDMMedTech info = new AfficherDMMedTech(utilisateur, utilisateur.getListePatient().get(i));
...
//            java.util.logging.Logger.getLogger(RechercherPatientDMMedTech.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RechercherPatientDMMedTech().setVisible(true);
//            }
//        });
//    }
