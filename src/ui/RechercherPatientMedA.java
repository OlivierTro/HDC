 ...
 * @author ANNELAURE
 */
public class RechercherPatientMedA extends javax.swing.JFrame {
    private Personnel utilisateur;

    /**
     * Creates new form RechercherPatientMedA
     */
    public RechercherPatientMedA(Personnel utilisateur) {
        initComponents();
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (i<utilisateur.getListePatient().size()){
            InfosMedecinAnest info = new InfosMedecinAnest(utilisateur, utilisateur.getListePatient().get(i));
...
//            java.util.logging.Logger.getLogger(RechercherPatientMedA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RechercherPatientMedA().setVisible(true);
//            }
//        });
//    }
