 ...
 * @author ANNELAURE
 */
public class RechercherPatientSecA extends javax.swing.JFrame {
    private Personnel utilisateur;
    

    /**
     * Creates new form RechercherPatientSecA
     */
    public RechercherPatientSecA(Personnel utilisateur) {
        initComponents();
    ...
    private void rechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rechercherActionPerformed
        ...
        if (i<utilisateur.getListePatient().size()){
            AfficherDMASecA info = new AfficherDMASecA(utilisateur, utilisateur.getListePatient().get(i));
...
//            java.util.logging.Logger.getLogger(RechercherPatientSecA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RechercherPatientSecA().setVisible(true);
//            }
//        });
//    }
