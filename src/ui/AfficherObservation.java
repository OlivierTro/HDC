 ...
 * @author ANNELAURE
 */
public class AfficherObservation extends javax.swing.JFrame {
    private Personnel utilisateur;
    private Patient patient;
    
    /**
     * Creates new form AfficherObservation
     */
    public AfficherObservation(Personnel utilisateur, Patient patient) {
        initComponents();
        ...
        while (i < patient.getListeSejour().size()){
            s +=patient.getListeSejour().get(i).afficherListeObs();
            i++;
        }
        texte.setText(s);
    }
...
//            java.util.logging.Logger.getLogger(AfficherObservation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new AfficherObservation().setVisible(true);
//            }
//        });
//    }
