...
public class ConnexionBD {
    ...
    public Service getService(String nomService) {
        ...
        if (nomService != null) {
            ...
            try {
                service = (Service) (new ServiceC(NomSC.valueOf(nomService),"Clinique"));
            } catch (IllegalArgumentException e1) {
                try {
                    service = (Service) (new ServiceMT(NomSMT.valueOf(nomService),"Medico-Technique"));
        ...
        if (idPH != null) {
            try {
                ...
                while (rst.next()) {
                    ...
                    Fonction fonction = getFonction(rst.getString("fonction"));
                    pHRespo = new PraticienHospitalier(nom, prenom, idPH, mdp, service, fonction);
                }
            } catch (SQLException e) {
    ...
    public boolean ajouterPrestation(Prestation pr) {
        boolean b = false;
        try {
            Statement st = connect.createStatement();
    ...
    public ArrayList<Soin> getSoins(Patient patient, Sejour sejour) {
