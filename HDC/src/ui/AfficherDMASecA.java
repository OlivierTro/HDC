 ...
 * @author ANNELAURE
 */
public class AfficherDMASecA extends javax.swing.JFrame {
    private Personnel utilisateur;
    private Patient patient;

    /**
     * Creates new form AfficherDMSecA
     */
    public AfficherDMASecA(Personnel utilisateur, Patient patient) {
        initComponents();
        this.setTitle("Afficher un DMA");
...
//            java.util.logging.Logger.getLogger(AfficherDMASecA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new AfficherDMASecA().setVisible(true);
//            }
//        });
//    }
